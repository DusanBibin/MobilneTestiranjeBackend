...
public class AccommodationsHostTabFragment extends Fragment {

    private FragmentAccommodationsHostTabBinding binding;
    private List<AccommodationHostItem> dataList;
    private AccommodationHostViewAdapter adapter;

    private Integer currentPage = 0;
    private Boolean isLastPage = false;
    public AccommodationsHostTabFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAccommodationsHostTabBinding.inflate(inflater, container, false);
